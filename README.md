 FeaturesMulti-Dataset Support: Cleans and processes multiple sources (cleaned_dataset.csv, sonucduygu.csv, twitter_racism_parsed_dataset (1).csv, Tesla.csv, and train.csv).VADER Sentiment Engine: Categorizes texts into Positive, Neutral, and Negative using NLTK.
